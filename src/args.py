...
def train_args():
    ...
    parser.add_argument('--window-size', default=.2, type=float, help='Window size for spectrogram in seconds')
    parser.add_argument('--window-stride', default=.1, type=float, help='Window stride for spectrogram in seconds')
    ...
    parser.add_argument('--sample-rate', default=1200, type=int, help='Sample rate')
